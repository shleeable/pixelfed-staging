...
Route::domain(config('pixelfed.domain.app'))->middleware(['localization'])->group(function () {
    ...
    Route::get('i/auth/checkpoint', [LoginController::class, 'showCheckpoint'])->middleware('auth')->name('auth.2fa.checkpoint');
    Route::post('i/auth/checkpoint', [LoginController::class, 'verifyCheckpoint'])->middleware(['auth', 'throttle:10,1'])->name('auth.2fa.checkpoint.verify');
    ...
    Route::name('passport.')->prefix('oauth')->middleware('oauth-web')->group(function () {
